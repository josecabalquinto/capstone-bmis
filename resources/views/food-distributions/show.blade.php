    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('distribute.index') }}">Food Distributions</a></li>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="{{ ucwords($fd->distributor) }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="{{ ucwords($fd->food) }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="{{ ucwords($fd->purok) }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea readonly class="form-control" cols="30" rows="10">{{ ucwords($fd->remarks) }}</textarea>
                        </div>
                    </div>
