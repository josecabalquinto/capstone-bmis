...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Weight for Height - Boys</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Weight for Height - Boys</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-header">
                    <h5>Weight (kg) for Height (cm) of Boys from 0-71 months</h5>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">New Weight for Height Standard - Boy</h4>
