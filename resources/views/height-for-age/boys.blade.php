...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Height for Age - Boys</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Height for Age - Boys</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                ...
                <div class="card-header">
                    <h5>Height (cm) for Age of Boys from 0-71 months</h5>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">New Height for Age Standard - Boy</h4>
                                    ...
                                    <form action="{{ route('hfa.store') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="o" class="col-sm-6 col-form-label">Gender
                                                *</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" value="Boy" name="gender"
                                                    id="gender" readonly>
